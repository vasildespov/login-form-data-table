    ...
    <div className="relative flex size-full w-full max-w-5xl flex-col">
      ...
      >
        {isLoading && (
          <LoaderCircle
            aria-hidden="true"
            className="fixed top-1/2 left-1/2 z-10 flex -translate-x-1/2 -translate-y-1/2 animate-spin items-center justify-center"
          />
        )}
        ...
        <Table className="relative">
          ...
          <TableBody className={cn(isLoading && "opacity-50 blur-[1px]")}>
            {data.success &&
